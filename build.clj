...
(def lib 'com.sturdystats/malli-firewall)
  ...
  (b/write-pom
   {:class-dir class-dir
    ...
    [[:description "A security-focused Clojure validation library built on Malli."]
     [:url "https://github.com/Sturdy-Statistics/sturdy-firewall"]
     [:licenses
      [:license
     ...
     [:scm
      ...
      [:url "https://github.com/Sturdy-Statistics/sturdy-firewall"]
      [:connection "scm:git:https://github.com/Sturdy-Statistics/sturdy-firewall.git"]]]})
